...
* **spriteOutputPath:**  path of directory to write sprite file to  [*Default:* process.cwd()]
* **cssOutputPath:**     path of directory to write css file to  [*Default:* process.cwd()]
* **base64:**            inlines base64 encoded sprites in the style file
* **spriteUrlBase:**     path or url of sprites on the web server used to reference the sprite in the styles (relative or absolute path or full url)  [*Default:* ../images]
