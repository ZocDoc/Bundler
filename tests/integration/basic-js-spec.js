...
test.describeIntegrationTest("Js Bundling:", function() {
    ...
    it("Given js files, then they are concatenated into the output bundle.", function() {
        ...
        test.given.BundleFileOption("require");
        test.given.FileToBundle('file1.js',    'var foo = require(\'./file4.js\'); var file1 = "file1";');
        test.given.FileToBundle('file2.js',    'var file2 = "file2";');
        test.given.FileToBundle('file4.js',    'var foo = require(\'./file2.js\'); var file4 = "file4";');
        ...
        test.assert.verifyBundleIs(
            ';var file2="file2";\n' +
            ';var foo=require("./file2.js"),file4="file4";\n' +
            ';var foo=require("./file4.js"),file1="file1";\n'
        );
